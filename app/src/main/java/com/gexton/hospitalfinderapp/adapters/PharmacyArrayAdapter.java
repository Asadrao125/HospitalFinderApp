...
public class PharmacyArrayAdapter extends ArrayAdapter<HospitalBean> {
    Context context;
    List<HospitalBean> hospitalBeanList;

    public PharmacyArrayAdapter(@NonNull Context context, List<HospitalBean> hospitalBeanList) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        img_hospital.setImageResource(R.drawable.pharmacy);
        return view;
    }
}
